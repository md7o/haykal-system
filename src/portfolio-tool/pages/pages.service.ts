...
export class PagesService {
  ...
  async create(portfolioId: string, createPageDto: CreatePageDto): Promise<Page> {
    ...
    const slug = generateSlug(createPageDto.slug);
  ...
  async findOne(id: string, portfolioId: string): Promise<Page | null> {
  ...
  async update(id: string, portfolioId: string, updatePageDto: UpdatePageDto): Promise<Page> {
  ...
  async remove(id: string, portfolioId: string): Promise<void> {
    const result = await this.pageRepository.delete({ id, portfolioId });
